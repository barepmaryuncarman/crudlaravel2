...
<li class="active"><a href="/employees"><i class="fa fa-users text-yellow"></i> <span>Employees</span></a></li>
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
                ...
                <div class="box-body">
					<table id="tabel_data_employee" class="table table-bordered table-striped">
						<thead>
							<tr>
								<th>No</th>
								<th>First Name</th>
	...
	function refresh_tabel(){
		$.ajax({
        	...
        	for(var i = 0; i < tmp.length; i++)
			{
				data[i] = new Array();
				data[i][0] = i;
				data[i][1] = tmp[i].firstName;
				data[i][2] = tmp[i].lastName;
				data[i][3] = tmp[i].extension;
				data[i][4] = tmp[i].email;
				data[i][5] = tmp[i].office.addressLine1;
				data[i][6] = tmp[i].leader[0].firstName;
				data[i][7] = tmp[i].jobTitle;
				data[i][8] = tmp[i].employeeNumber;
			}
