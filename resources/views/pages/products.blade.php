...
@section('side-menu')
<li class="active"><a href="/products"><i class="fa fa-cubes text-gray"></i> <span>Products</span></a></li>
<li><a href="/employees"><i class="fa fa-users text-gray"></i> <span>Employees</span></a></li>
<li><a href="/customers"><i class="fa fa-users text-gray"></i> <span>Customers</span></a></li>
<li><a href="/offices"><i class="fa fa-building-o text-gray"></i> <span>Offices</span></a></li>
<li><a href="/orders"><i class="fa fa-list text-gray"></i> <span>Orders</span></a></li>
@endsection
